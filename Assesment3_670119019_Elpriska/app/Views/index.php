								...
								<ul class="header-cart-wrapitem">
									...
									<div class="header-cart-buttons">
										<div class="header-cart-wrapbtn">
											...
											<div class="header-cart-wrapbtn">
												<!-- Button --> 
												<a href="profil.php?id=<?php echo $_SESSION['pelanggan']['id_pelanggan'];?>" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">MyProfile</a>
												<?php else:?>
...
<section class="slide1">
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1 item1-slick1" style="background-image: url(data/images/abc.jpeg);">
			...
			<div class="item-slick1 item2-slick1" style="background-image: url(data/images/hij.jpeg);">
				<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
			...
			<div class="item-slick1 item3-slick1" style="background-image: url(data/images/klm.jpeg);">
				<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
		...
		<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
			...
			<div class="t-center p-l-15 p-r-15">
				...
				<div class="t-center s-text8 p-t-20">
					Copyright © 2020 All rights reserved. | This Website was Created <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Rahel</a>
				</div>
			</div>
		</footer>
