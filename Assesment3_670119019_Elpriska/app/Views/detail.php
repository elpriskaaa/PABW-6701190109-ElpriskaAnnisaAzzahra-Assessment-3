	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<img src="foto_produk/<?php echo $detail["gambar"];?>" height="280">
			</div>
			</div>
			<div class="col-md-6">
				<h2><?php echo $detail['judul_desain'];?></h2>
				<h4>Harga       	: Rp.<?php echo number_format($detail['harga']);?></h4>
				<h5>Nama Arsitek   	: <?php echo $detail['nama_arsitek'];?></h5>
